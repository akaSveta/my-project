...
public class ExamController {
    ...
    @PostMapping("/answer")
    public String saveAnswer(@RequestParam("id") Long questionId,
                             @RequestParam(value = "answer", required = false) String singleAnswer,
                             @RequestParam(value = "answers", required = false) List<String> multipleAnswers,
                             HttpSession session) {
        ...
        UserAnswer userAnswerObj = new UserAnswer(
                questionId,
                userAnswer,
                isCorrect,
                question.getCorrectAnswer(),
                question.getExplanation(),
                question.getQuestionsText()
        );
